...
<head>
    ...
    {
        $I_brand=$_GET["pro_brand"];
        require "../server/Databaseconnection.php";
        $insertquery= "insert into brands (Bname) value('$I_brand')";
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="pro_title" name="pro_brand" placeholder="Enter Brand" required>
                </div>
            </div>
        </div>
        <div class="row my-3">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <button type="submit" class="btn btn-primary btn-block" name="button" ><i class="fas fa-plus"></i> Insert Now </button>
            </div>
        </div>
    </form>
</div>
