...
<head>
    ...
    {
        $I_category=$_POST["pro_category"];
        require "../server/Databaseconnection.php";
        $insertquery= "insert into categories (Cname) value('$I_category')";
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="pro_title" name="pro_category" placeholder="Enter Category" required>
                </div>
            </div>
        </div>
        <div class="row my-3">
